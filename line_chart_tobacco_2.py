...
def plot_line_chart(data):
    ...
    plt.legend()
    plt.savefig('line_chart_tobacco_2_top_3.png')  # Save the plot to a file
    print("Line chart saved as 'line_chart_tobacco_2_top_3.png'")

if __name__ == "__main__":
    file_path = 'tobacco-2.xlsx'  # Update this path to your actual data file
